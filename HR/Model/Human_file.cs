...
namespace Model
{
    public class Human_file
    {
        ...
        public string human_birthday { get; set; }
        ...
        public string major_change_amount { get; set; }
        public string bonus_amount { get; set; }
        public string training_amount { get; set; }
        public string file_chang_amount { get; set; }
        ...
        public string lastly_change_time { get; set; }
        public string delete_time { get; set; }
        public string recovery_time { get; set; }
        public string human_file_status { get; set; }
